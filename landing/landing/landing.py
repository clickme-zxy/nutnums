...
def index() -> rx.Component:
    return rx.fragment(
        ...
        rx.hstack(
            rx.vstack(
                rx.text("Nutnums, streamlines your collecting experience, treasure hunting made easy",font_size="3em",as_="b"),
                rx.text("",font_size= "3em"),
                rx.text("For fans by fans",as_="i",font_size="3em"),
                width = "70%"
            ),
...
1. There are too many editions or series or other nuanced info, it’s hard to keep up with all, which can be discouraging to MANY of us. [1]
2. Even with comprehensive information, it’s still challenging to browse through different markets accordingly, track across multiple social media platforms to find listings for the exact item you want, which may take hours, days and even months of effort. 
3. Hard to manage and keep track of what we have and what we want.
